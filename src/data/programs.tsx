...
export const programs: Program[] = [
  ...
  },
  {
    ...
    weeklyBreakdown: [
      { week: 1, title: "Week 1: Expressions, Equations, and Inequalities", description: "Order of operations, combining like terms, evaluating expressions.", topics: ["Intro to variables", "Simplifying equations", "Constant values", "Simplifying Inequalities", "Simplifying expressions", "Solution sets"], project: "Create and evaluate expressions representing real-world scenarios" },
      { week: 2, title: "Week 2: Equations & Inequalities with Graphing", description: "Solving one-step and multi-step equations, graphing inequalities.", topics: ["Domain & Range", "Slope & Intercepts", "Relations & functions", "Graphing functions", "Linear functions", "Function notation"], project: "Solve and graph linear inequalities representing real constraints" },
      { week: 3, title: "Week 3: Solving Systems & Lines", description: "Slope, y-intercept, graphing lines, slope-intercept form.", topics: ["Systems of linear equations", "Parallel & perpendicular lines", "Number of solutions", "Graphing inequalities", "Systems of inequalities", "Writing inequalities"], project: "Model and analyze real-world linear relationships" },
